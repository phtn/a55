...
import { isFirebaseCustomClaims, type FirebaseCustomClaims } from '../../lib/firebase/custom-claims'
...
const usage = [
  'Usage:',
  '  bun run firebase:set-custom-claims -- --uid <uid> --claims \'{\"admin\":true}\' [--merge]',
  '  bun run firebase:set-custom-claims -- --email <email> --claims \'{\"role\":\"staff\"}\' [--merge]',
  '',
  'Notes:',
